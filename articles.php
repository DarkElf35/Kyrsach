                        ...
                        <div class="block">
                            ...
                            <div class="block__content">
                                <div class="articles articles__horizontal">
                                    ...
                                    $articles = mysqli_query($connection, "SELECT * FROM `articles` ORDER BY `id` ASC LIMIT $offset,$per_page");
                                    $articles_exist = true;
                                ...
                                if ( $articles_exist == true  ) 
                                {
                                    ...
                                    if ( $page < $total_pages ) 
                                    {
                                        echo '<a href="/articles.php?page='.($page + 1).'">Следующая страница &raquo;</a>';                        //пагинатор не работает, ошибку и причину ошибки не установил возможно проблемы с get и post
                                    }
                                    echo '</div>';
                                }
                                ?>
